...
NVIDIA_TF32_OVERRIDE=1 CUDA_VISIBLE_DEVICES=2 python rl/train_agent.py --length_scale 4.0 --grid_size 33 --budgets 15 30 45 60 --dog_max_range 1.2 1.8 --total_timesteps 500000000 --turbulence_scale 0.0 --valley_gradient_mag 0.0 --noise_std 0.2
```
